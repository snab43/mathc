...
// Top              (sprite, subimg, left, top, width, height,     x,  y,      xscale, yscale,  colour, alpha);
...
// Middle           (sprite, subimg, left, top, width, height,     x,     y,      xscale,      yscale,  colour, alpha);
...
// Bottom           (sprite, subimg, left,  top, width, height,     x,     y,      xscale, yscale,  colour, alpha);
