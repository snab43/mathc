...
if (o_battle.play and instance_exists(stats_object)) {
    // Add to the action meter
    action_meter = min(action_meter+(stats_object.stats[? "speed"]+(stats_object.level+spd_mod)*2)/10, max_action_meter);
